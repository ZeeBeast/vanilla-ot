...
function onSay(cid, words, param, channel)
	...
	elseif(t[1] == 'donate') then
		...
		doPlayerSendChannelMessage(cid, '', 'Current balance of guild ' .. result:getDataString('name') .. ' is: ' .. result:getDataLong('balance') .. ' gold coins.', TALKTYPE_CHANNEL_HIGHLIGHT, CHANNEL_GUILD)
		result:free()
	end
